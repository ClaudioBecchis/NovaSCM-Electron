        ...
        <div style={{
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input className="form-input" value={settingsForm.iventoy_ip || ''} onChange={e => updateSetting('iventoy_ip', e.target.value)} placeholder="192.168.10.122" style={{ fontFamily: 'var(--font-mono)' }} />
            </div>
            <div className="form-group">
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <input className="form-input" value={settingsForm.default_domain || ''} onChange={e => updateSetting('default_domain', e.target.value)} placeholder="corp.polariscore.it" />
            </div>
          </div>
          <div className="form-row">
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input className="form-input" value={settingsForm.default_dc_ip || ''} onChange={e => updateSetting('default_dc_ip', e.target.value)} placeholder="192.168.10.199" style={{ fontFamily: 'var(--font-mono)' }} />
            </div>
          </div>
          <div className="form-row">
            <div className="form-group">
